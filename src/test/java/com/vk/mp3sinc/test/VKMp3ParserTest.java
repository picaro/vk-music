...
public class VKMp3ParserTest {
    ...
    " <div class=\"title_wrap\"><b><a href=\"http://vkontakte.ru/search?c[q]=Bahh%20Tee&c[section]=audio\" onclick=\"if (checkEvent(event)) return; Audio.selectPerformer(event, &#39;Bahh Tee&#39;); return false\">Bahh Tee</a></b> - <span class=\"title\">�������� ���� (SunJinn prod.) </span><span class=\"user\"></span></div>" +
    "</td>" +
    "<td><a id=\"6220607_118004365\" href=\"http://cs4623.vkontakte.ru/u55655941/audio/fa12606d45de.mp3?/Bahh%20Tee%20-%20%CD%E5%ED%E0%E2%E8%E4%FC%20%EC%E5%ED%FF%20(SunJinn%20prod.).mp3\" class=\"downloadbtn\" title=\"��� �������� ���������� ������" +
    " ������ � ������ �����\" download=\"Bahh Tee - �������� ���� (SunJinn prod.).mp3\" parsed=\"1\"><img src=\"chrome-extension://hanjiajgnonaobdlklncdjdmpbomlhoa/res/download.gif\" width=\"16\" height=\"17\"\";";
	...
	public void testGetAllMp3s() {
		...
		assertEquals("http://cs4623.vkontakte.ru/u55655941/audio/fa12606d45de.mp3",mp3s.get("Bahh Tee - �������� ���� (SunJinn prod.)"));
